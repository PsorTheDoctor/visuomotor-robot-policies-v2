...
class PushTEnv(gym.Env):
    ...
    def _render_frame(self, mode):
        ...
        if self.render_action:
            if self.render_action and (self.latest_action is not None):
                ...
                self.action_history.append(coord)
        return img

    def save_action_history(self, filename):
        np.save(filename, np.array(self.action_history))
    ...
    def _setup(self):
        ...
        self.agent = self.add_circle((256, 500), 15)
...
class PushTImageEnv(PushTEnv):
    ...
    def __init__(
        self, legacy=False, block_cog=None, damping=None, render_size=96
    ):
        super().__init__(
